...
PACKAGE_DIR = Path(__file__).resolve().parent               # adl/Extractors/odata/
...
from adl.Extractors.odata import client as odata_module
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--config",
        default=str(ADL_ROOT / "DataObjectMappings" / "cbs.json"),
        help="path to the DWA-style configuration file (default: adl/DataObjectMappings/cbs.json)",
    )
    parser.add_argument(
        "--mapping",
