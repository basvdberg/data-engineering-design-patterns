...
<!-- markdown-toc:start -->
- [Split into two patterns](#split-into-two-patterns)
<!-- markdown-toc:end -->

## Split into two patterns

This pattern is split into:

- [Simplicity](simplicity.md)
- [Functional decomposition](functional-decomposition.md)

Use these files for new references. Keep this file as a compatibility entry point.
...
- [Data Engineering Design Patterns](../../readme.md)
  ...
  - Design patterns
    - Data engineering
      ...
      - [Data object property tree](../data-engineering/object-property-tree.md)
    - Generic
      - [Functional decomposition](functional-decomposition.md)
