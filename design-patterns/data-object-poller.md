...
`DataObjectPoller` watches configured objects on a schedule, detects marker changes without reading full payloads, and publishes events for [event-based orchestration](event-based-orchestration.md). 
